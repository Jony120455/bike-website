    ...
    <Container style={{height:'100vh'}} className="bg-1 d-flex align-items-center justify-content-center">
        ...
        <div className="row align-items-center">
          <div className="col-12 col-md-6 p-3">
            <img src="https://i.gifer.com/OyGx.gif" alt="" className="w-100" />
          </div>
          <div className="col-12 col-md-6 bg-danger p-3">
            ...
            <Button className="text-center bg-success mx-1" onClick={handleGoogleLog}>Google log in</Button>
            {/* <Link className="text-center" to="/regi"><small>new user</small></Link> */}
            <Link to="/regi" className="mx-1"><Button className="bg-success">new user</Button></Link>
