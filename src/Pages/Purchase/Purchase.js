...
const Purchase = () => {
    ...
    useEffect(()=>{
        fetch(`https://quiet-retreat-22689.herokuapp.com/products/${id}`)
        .then(res => res.json())
            ...
            <NavBar/>
                <div className="row">
                    ...
                    <Card className="bg-dark text-white">
                        <Card.Img id="overlayImg" style={{height:'90vh'}} className="w-100" src='https://cdn.cbeditz.com/cb/uploads/KTM-Bike-Blur-CB-Editing-Background-Download.jpg' alt="Card image" />
                        <Card.ImgOverlay>
                            <Container>
                            <div className="row mt-5">
                                <div className="col-12 col-md-4">
                                    <div className="p-5" style={{background:'gray'}}>
                                ...
                                <div className="col-12 col-md-8">
                                    <div className="p-5" style={{background:'#F8F9F9',opacity:'80%'}}>
